...
export const GoogleXPaths = {
  ...
  g_step2_image_xpath: "//div[@id='sg-product__pdp-container']//img/@src",
  ...
  a_asin_xpath:
    "//span[@data-component-type='s-search-results']//div[@data-asin][.//a[contains(@class, 'a-link-normal a-text-normal') and not(contains(@href,'slredirect'))]][1]/@data-asin",
  a_price_xpath:
    "concat(//span[@data-component-type='s-search-results']//div[@data-asin][.//a[contains(@class, 'a-link-normal a-text-normal') and not(contains(@href,'slredirect'))]][1]//span[@class='a-price-whole'],//span[@data-component-type='s-search-results']//div[@data-asin][.//a[contains(@class, 'a-link-normal a-text-normal') and not(contains(@href,'slredirect'))]][1]//span[@class='a-price-fraction'])",
  a_prime_xpath:
    "//span[@data-component-type='s-search-results']//div[@data-asin][.//a[contains(@class, 'a-link-normal a-text-normal') and not(contains(@href,'slredirect'))]][1]//i[@aria-label='Amazon Prime']/@aria-label",
  a_ship_xpath:
    "//span[@data-component-type='s-search-results']//div[@data-asin][.//a[contains(@class, 'a-link-normal a-text-normal') and not(contains(@href,'slredirect'))]][1]//span[contains(text(), 'Shipping') or contains(text(), 'shipping') or contains(text(), 'FREE')]",
  a_title_xpath:
    "//span[@data-component-type='s-search-results']//div[@data-asin][.//a[contains(@class, 'a-link-normal a-text-normal') and not(contains(@href,'slredirect'))]][1]//span[contains(@class,'a-text-normal')]",
  a_image_xpath:
    "//span[@data-component-type='s-search-results']//div[@data-asin][.//a[contains(@class, 'a-link-normal s-no-outline') and not(contains(@href,'slredirect'))]][1]//img[contains(@class,'s-image')]/@src",
};
